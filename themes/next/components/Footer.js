  ...
  return (
        ...
        >
            ...
            <span>
                ...
                <br />
                <h1>{title}</h1>
                <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '>放学后茶会Blog  <a href='https://t.me/fangxuehou' className='underline '>点击纸飞机加入群组✈️ {BLOG.VERSION}</a>.</span>
            </span>
        </footer>
  )
}
