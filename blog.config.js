...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '放学后茶会.Bolg', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '点击纸飞机加入群组', // 作者简介
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '100082862505150', // Facebook Page ID 來啟用 messenger 聊天功能
  ...
  PREVIEW_CATEGORY_COUNT: , // 首页最多展示的分类数量，0为不限制
  PREVIEW_TAG_COUNT: ,// 首页最多展示的标签数量，0为不限制
